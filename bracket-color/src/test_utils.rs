...
pub(crate) fn assert_approx_eq(left: f32, right: f32) {
    assert!((left - right).abs() < 1e-6);
}

#[allow(clippy::missing_panics_doc)]
pub(crate) fn assert_rgb_eq(rgb: RGB, r: f32, g: f32, b: f32) {
...
#[allow(clippy::missing_panics_doc)]
pub(crate) fn assert_rgba_eq(rgba: RGBA, r: f32, g: f32, b: f32, a: f32) {
...
#[allow(clippy::missing_panics_doc)]
pub(crate) fn assert_hsv_eq(hsv: HSV, h: f32, s: f32, v: f32) {
